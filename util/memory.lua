...
local memoryNames = {
    ...
    game = {map = 0x135E, frames = 0x1A45, battle = 0x1057, textbox = 0x0FC4},
    shop = {transaction_amount = 0x0F96},
    progress = {trashcans = 0x1773},
    pokemon = {exp1 = 0x1179, exp2 = 0x117A, exp3 = 0x117B},
    battle = {
        confused = 0x106B,
        turns = 0x1067,
        text = 0x1125,
...
function memory.value(section, key)
    ...
    if (key) then memoryAddress = memoryAddress[key] end
